...
```
Result:
   - Docker network web-net created
   - Nginx image pulled
   - Container advanced-nginx running
   - Port 8001 mapped to container’s port 80
   - Host folder /home/hlodha/html mounted into container
